...
const MessageList: FC<MessageListProps> = ({ children }) => {
  ...
  return (
    <div
      ...
      className="mx-3 my-2 h-full min-h-0 overflow-y-auto overscroll-none rounded-2xl border border-white/40 bg-white/45 shadow-inner backdrop-blur-xl dark:border-white/8 dark:bg-slate-900/45"
    >
      {renderedChildren}
    </div>
  )
